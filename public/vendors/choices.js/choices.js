                ...
                !function (e, t) {
                    ...
                    return function (e) {
                        ...
                        var i = n(2), a = n(8), s = n(0), c = function () {
                            function e(t, n) {
                                var r = n.location, o = void 0 === r ? 0 : r, i = n.distance, s = void 0 === i ? 100 : i, c = n.threshold,
                                    h = void 0 === c ? .6 : c, l = n.maxPatternLength, u = void 0 === l ? 32 : l, f = n.caseSensitive,
                                    d = void 0 !== f && f, v = n.tokenSeparator, p = void 0 === v ? / +/g : v, g = n.findAllMatches,
                                    y = void 0 !== g && g, m = n.minMatchCharLength, k = void 0 === m ? 1 : m, S = n.id, x = void 0 === S ? null : S,
                                    b = n.keys, M = void 0 === b ? [] : b, _ = n.shouldSort, L = void 0 === _ || _, w = n.getFn,
                                    A = void 0 === w ? a : w, C = n.sortFn, I = void 0 === C ? function (e, t) {
                                        return e.score - t.score
                                    } : C, O = n.tokenize, j = void 0 !== O && O, P = n.matchAllTokens, F = void 0 !== P && P, T = n.includeMatches,
                                    z = void 0 !== T && T, E = n.includeScore, K = void 0 !== E && E, $ = n.verbose, J = void 0 !== $ && $;
                                !function (e, t) {
                            ...
                            return t = e, (n = [{
                                ...
                                key: "search", value: function (e) {
                                    ...
                                    var n = this._prepareSearchers(e), r = n.tokenSearchers, o = n.fullSearcher, i = this._search(r, o),
                                        a = i.weights, s = i.results;
                                ...
                                key: "_search", value: function () {
                                    ...
                                    for (var s = {}, c = 0, h = n.length; c < h; c += 1) for (var l = n[c], u = 0, f = this.options.keys.length; u < f; u += 1) {
                                        ...
                                        this._analyze({key: d, value: this.options.getFn(l, d), record: l, index: c}, {
                                            resultMap: r,
                                            results: o,
                                            tokenSearchers: e,
                                            fullSearcher: t
                                ...
                                key: "_analyze", value: function (e, t) {
                                    var n = e.key, r = e.arrayIndex, o = void 0 === r ? -1 : r, i = e.value, a = e.record, c = e.index,
                                        h = t.tokenSearchers, l = void 0 === h ? [] : h, u = t.fullSearcher, f = void 0 === u ? [] : u,
                                        d = t.resultMap, v = void 0 === d ? {} : d, p = t.results, g = void 0 === p ? [] : p;
                                    if (null != i) {
                                        var y = !1, m = -1, k = 0;
                                        if ("string" == typeof i) {
                                            this._log("\nKey: ".concat("" === n ? "-" : n));
                                            ...
                                            if (this._log("\nCheck Matches: ".concat(F)), (y || S.isMatch) && F) {
                                                ...
                                                T ? T.output.push({
                                                    ...
                                                    item: a,
                                                    output: [{key: n, arrayIndex: o, value: i, score: P, matchedIndices: S.matchedIndices}]
                                                }, g.push(v[c]))
                                            }
                        ...
                        var o = n(3), i = n(4), a = n(7), s = function () {
                            function e(t, n) {
                                var r = n.location, o = void 0 === r ? 0 : r, i = n.distance, s = void 0 === i ? 100 : i, c = n.threshold,
                                    h = void 0 === c ? .6 : c, l = n.maxPatternLength, u = void 0 === l ? 32 : l, f = n.isCaseSensitive,
                                    d = void 0 !== f && f, v = n.tokenSeparator, p = void 0 === v ? / +/g : v, g = n.findAllMatches,
                        ...
                        e.exports = function (e, t) {
                            var n = t.errors, r = void 0 === n ? 0 : n, o = t.currentLocation, i = void 0 === o ? 0 : o, a = t.expectedLocation,
                                s = void 0 === a ? 0 : a, c = t.distance, h = void 0 === c ? 100 : c, l = r / e.length, u = Math.abs(s - i);
...
// CONCATENATED MODULE: ./node_modules/redux/es/redux.js
                 ...
                 * previously serialized employee session.
                ...
                function createStore(reducer, preloadedState, enhancer) {
                     ...
                     * a good idea to keep actions serializable so you can record and replay employee
 ...
 * If the function has been minified and NODE_ENV !== 'production', warn the employee.
 */
...
// CONCATENATED MODULE: ./src/scripts/components/dropdown.js
                ...
                var Dropdown =
                    ...
                    function () {
                        ...
                        /**
                         * Show dropdown to employee by adding active state class
                         * @returns {this}
                         */
                        ;
                    ...
                    function () {
                        ...
                        _proto.removeHighlightedItems = function removeHighlightedItems(runEvent) {
                            ...
                            this._store.highlightedActiveItems.forEach(function (item) {
                                _this6._removeItem(item); // If this action was performed by the employee
                                // trigger the event
                        ...
                        _proto._createChoicesFragment = function _createChoicesFragment(choices, fragment, withinGroup) {
                            ...
                            var _rendererableChoices$ = rendererableChoices.reduce(function (acc, choice) {
                                ...
                                normalChoices = _rendererableChoices$.normalChoices; // If sorting is enabled or the employee is searching, filter choices
                        ...
                        _proto._handleItemAction = function _handleItemAction(activeItems, element, hasShiftKey) {
                            ...
                            }); // Focus input as without focus, a employee cannot do anything with a
                            // highlighted item
                        ...
                        _proto._onKeyDown = function _onKeyDown(event) {
                            ...
                            var hasCtrlDownKeyPressed = ctrlKey || metaKey; // If a employee is typing and the dropdown is not active
                        ...
                        _proto._addPredefinedChoices = function _addPredefinedChoices(choices) {
                            ...
                            // If sorting is enabled or the employee is searching, filter choices
                            if (this.config.shouldSort) {
